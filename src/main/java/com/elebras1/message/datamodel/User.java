...
public class User extends AbstractMessageAppObject implements IMessageRecipient {
	...
	public boolean equals(Object o) {
		...
		User user = (User) o;
		return Objects.equals(mUserTag, user.mUserTag) && Objects.equals(mUserPassword, user.mUserPassword) && Objects.equals(mName, user.mName);
	}

	@Override
	public int hashCode() {
		return Objects.hash(super.hashCode(), mUserTag, mUserPassword, mName);
	}
}
